...
<script>
	var gFontsFamilies = ["Fredoka One"];
</script>
<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Fredoka+One:regular&subset=latin">
...
function init() {
	...
	var comp=AdobeAn.getComposition("6F09669B17AA4BA493DE51C3BD050531");
	var lib=comp.getLibrary();
	try {
...
<body onload="init();" style="margin:0px;">
	<div id="animation_container" style="background-color:rgba(85, 162, 210, 1.00); width:960px; height:540px">
		<canvas id="canvas" width="960" height="540" style="position: absolute; display: block; background-color:rgba(85, 162, 210, 1.00);"></canvas>
